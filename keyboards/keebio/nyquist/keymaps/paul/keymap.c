 ...
 * |Shift(|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  /   |Shift)|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |AltGr |  Alt | GUI  |Lower |Space |Raise |SpCtrl| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_FFXIV] = LAYOUT( \
  ...
  KC_LSPO, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, \
  KC_LCTL, KC_ALGR, KC_RALT, KC_LGUI, LOWER,   KC_SPC,  RAISE,   RCTL_T(KC_SPC), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT \
),
